...
function parseX12toJsonWithoutLoops(ediData) {
  if (ediData === undefined || ediData === "" || typeof ediData !== "string") {
...
// Usage example
const ediFilePath = "./X222-COB-claim-from-billing-provider-to-payer-a.edi";
let ediData = fs.readFileSync(ediFilePath, "utf8");

const output = parseX12toJsonWithoutLoops(ediData);
